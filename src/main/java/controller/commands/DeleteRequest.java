 ...
 */
public class DeleteRequest implements Action {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageTogo = "/WEB-INF/views/personal.jsp";

        dispatcherRequestService.deleteRequest(Integer.parseInt(requestId));
