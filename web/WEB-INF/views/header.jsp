                ...
                <c:otherwise>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><fmt:message
                                key="navbar.login"/><span class="caret"></span></a>
                                        ...
                                        <form class="form" role="form" method="post" action="${pageContext.request.contextPath}/pages/login"
                                            ...
                                            <div class="form-group">
                                                <label class="sr-only" for="exampleInputEmail2"><fmt:message
                                                        key="navbar.login.email"/></label>
                                                <input type="email" name="email" class="form-control"
                                                       id="exampleInputEmail2"
                                                       placeholder="<fmt:message key="navbar.login.email"/>" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="exampleInputPassword2"><fmt:message
                                                        key="navbar.login.password"/></label>
                                                <input type="password" name="password" class="form-control"
                                                       id="exampleInputPassword2"
                                                       placeholder="<fmt:message key="navbar.login.password"/>"
                                                       required>
